...
public class DebitTransactionTest extends BaseClass {

	@Test(priority = 0, enabled = true)
	public void DebitTransactionRecent() throws InterruptedException {

		SoftAssert assert1 = new SoftAssert();
		DecimalFormat f1 = new DecimalFormat("#.##");
		home.clickOnDebitTransaction();
		...
		String[] actClosingBlcArray = columnsOfRow1.get(4).getText().split(" ")[1].split(",");
	...
	public void DebitTransactionToday() throws InterruptedException {
	...
	public void DebitTransactionYesterday() throws InterruptedException {
		...
		/*
		 * Validating the Opening blc from transaction entries with opening blc tab
		 */
		if (!(transcationFilter.getNoRow().get(0).findElement(By.tagName("td")).getText()
				.contains("no matching records found"))) {
			List<WebElement> columnsOfRow25 = allRows.get(allRows.size() - 1).findElements(By.tagName("td"));
	...
	public void DebitTransactionLast7Days() throws InterruptedException {
	...
	public void DebitTransactionLast30Days() throws InterruptedException {
	...
	public void DebitTransactionCustom() throws InterruptedException {
